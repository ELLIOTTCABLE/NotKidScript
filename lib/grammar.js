...
var grammar = {
    ...
    {"name": "expression", "symbols": ["parenthesized_expression"], "postprocess": id},
    ...
    {"name": "exp", "symbols": [(lexer.has("number") ? {type: "number"} : number), "_", (lexer.has("exp") ? {type: "exp"} : exp), "_", "exp"], "postprocess": infix},
    {"name": "exp", "symbols": [(lexer.has("number") ? {type: "number"} : number)], "postprocess": ([num]) => $('number', num.value)},
